...
- If **SUFFICIENT:** set label `ready-for-implementation` and a feature branch name.
- If **NEEDS IMPROVEMENT:** set label `needs-clarification` and **specific questions** (not generic).
